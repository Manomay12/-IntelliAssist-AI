"""
Document Summarizer Page View for IntelliAssist AI.
Generates multi-mode summaries, extracts topics, discovers key entities, and formats downloadable briefs.
"""
...
def render_summarizer_page(
    ...
    <div style="margin-bottom:20px;">
        <div style="display:flex; align-items:center; gap:10px;">
            <h2 style="font-weight:800; color:#ffffff; margin:0; letter-spacing:-0.02em;">📝 Smart Document Summarizer</h2>
        ...
        <p style="color:#94a3b8; font-size:0.92rem; margin:4px 0 0 0;">
            Synthesize complex papers, reports, and notes into executive summaries, key bullet points, and extracted entities.
        </p>
    </div>
    ...
    if not all_documents:
        ...
        <div class="modern-card" style="text-align:center; padding:36px 20px;">
            ...
            <div style="font-weight:700; font-size:1.1rem; color:#f8fafc; margin-bottom:6px;">No documents available to summarize</div>
            <p style="font-size:0.88rem; color:#94a3b8; max-width:400px; margin:0 auto 16px auto;">
                Please upload a PDF, DOCX, or TXT document on the Documents page or load sample documents to generate AI summaries.
            </p>
        </div>
        """, unsafe_allow_html=True)
        return
    ...
    # Determine if we should generate summary now
    # If explicitly clicked OR no summary exists for this document yet, generate automatically!
